...
const FALLBACK_IMAGES = {
  electronics: 'https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60',
...
const CartPage = () => {
  ...
  const handleImageError = (e, category) => {
    const fallbackCategory = category?.toLowerCase() || 'default';
    const fallbackImage = FALLBACK_IMAGES[fallbackCategory] || FALLBACK_IMAGES.default;
